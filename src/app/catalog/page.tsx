  ...
  return (
    <>
      <div className="page-head">
        <h1>Catalog</h1>
        <p>
          Define what the client sells. Every feature sits in one of three states on every tier, and
          add-ons are priced per tier — the same feature can cost more on Growth than on Enterprise.
        </p>
      </div>
