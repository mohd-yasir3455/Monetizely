  ...
  try {
    ...
    return (
      <>
        <div className="page-head">
          <h1>Build a quote</h1>
          <p>
            Only what the catalog allows on the chosen tier can be selected. Included features come
            at no cost; unavailable ones never appear.
          </p>
        </div>
    ...
    return (
      <>
        ...
        <PageErrorState
          title="The quote builder is unavailable"
